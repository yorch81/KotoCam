 ...
 * Tele<br>
 * 
 * Tele Implementation of Filter<br><br>
 * 
 ...
 */
public class Tele extends Filter {
	...
	public BufferedImage process(BufferedImage img) {
		MarvinImagePlugin imagePlugin = MarvinPluginLoader.loadImagePlugin("org.marvinproject.image.artistic.television.jar");
